...
;; nelisp-emacs: VENDORED VERBATIM from GNU Emacs 30.1 (lisp/emacs-lisp/rx.el).
;; Unblocked after reader-core A16 (concat nil), A17 (POSIX regex classes),
;; regexp-opt, and A18 (mapcan no-op-stub shadowing) were fixed.
;; rx-let/rx-define remain limited by A12 (macroexpand-all env).  GPLv3.
